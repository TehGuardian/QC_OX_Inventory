...
return {
    ...
    ['coffee'] = {
        ...
        stack = true,
        close = true,
        description = 'A hot cup of coffee to warm you up.',
        client = {
            image = 'coffee.png',
        },
    },
    ...
    ['handcuffs'] = {
        ...
        stack = false,
        close = true,
        description = 'Used to restrain suspects.',
        client = {
            image = 'handcuffs.png',
        },
    },
    ...
    ['blood_dollar'] = {
        ...
        stack = true,
        close = true,
        description = 'A dollar obtained through illicit means.',
        client = {
    ...
    ['blood_cent'] = {
        ...
        stack = true,
        close = true,
        description = 'A cent obtained through illicit means.',
        client = {
