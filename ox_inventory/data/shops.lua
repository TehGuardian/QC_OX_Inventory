...
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                                               ║
║                           🏪 OX INVENTORY - SHOP SYSTEM 🏪                                                   ║
║                                                                                                               ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║                                                                                                               ║
║  Define shops and their inventory                                                                             ║
║  Multi-Framework: RSG, VORP, QRCore, RedEM:RP                                                                 ║
║                                                                                                               ║
║  📋 PROPERTIES 📋                                                                                            ║
║    • name       Shop display name                                                                             ║
║    • groups     Job/gang restrictions (optional)                                                              ║
║    • blip       Map blip settings                                                                             ║
║    • inventory  Items for sale {name, price, metadata, curr ency}                                             ║
║    • locations  Interaction points (array)                                                                    ║
║    • targets    Target zones (array)                                                                          ║
║    • model      Shop ped models (for global shop access)                                                      ║
║                                                                                                               ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
--]]
